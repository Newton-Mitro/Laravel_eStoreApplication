        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title text-bold">Create New Shipping Discount</h3>
                </div>
                <div class="card-body">
                    <div class="card-body">
                        <form method="POST" action="{{ route('shippingdiscount.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="cart_total" type="number"
                                           ...
                                           name="cart_total"
                                           value="{{ old('cart_total') }}" autocomplete="cart_total" autofocus step="any">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="discount_amount" type="number"
                                           ...
                                           value="{{ old('discount_amount') }}" autocomplete="discount_amount" autofocus step="any">
