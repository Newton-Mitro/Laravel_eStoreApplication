    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-bold">New Barand</h3>
            </div>
            <div class="card-body">
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="custom-file">
                                    <div class="input-group"><span class="input-group-btn">
                                        ...
                                        <input id="thumbnail" class="form-control @error('brand_name') is-invalid @enderror" type="text" name="brand_image" placeholder="300 X 80">
                                    </div>
                                </div>
