            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{route('users.index')}}">All User</a></li>
                        <li class="breadcrumb-item active">Edit User</li>
                    </ol>
                </div>
            </div>
            <div class="row mt-3 mb-2">
                <a href="{{route('user.show',['id'=>$user->id])}}" class="btn btn-sm btn-warning">View User</a>
            </div>
        </div>
    </section>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="f_name" type="text"
                                       ...
                                       value="{{ $user->f_name }}" autocomplete="f_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="l_name" type="text"
                                       ...
                                       value="{{ $user->l_name }}" autocomplete="l_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="role_id" id="">
                                    <option name="role_id" value="0">Select Role</option>
                                    @foreach($roles as $role)
                                        @if($user->role_id == $role->id)
                                            <option name="role_id" selected value="{{$role->id}}">{{$role->role_name}}</option>
                                        @else
