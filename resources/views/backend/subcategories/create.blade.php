            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{route('sub_category.index')}}">Sub-Categories</a></li>
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-bold">New Sub-Category</h3>
            </div>
            <div class="card-body">
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('category_id') is-invalid @enderror" name="category_id" id="category_id">
                                    <option name="category_id" value="0">Select Category</option>
                            ...
                            <div class="col-md-6">
                                <div class="custom-file">
                                    <div class="input-group"><span class="input-group-btn">
                                        ...
                                        <input id="thumbnail" class="form-control @error('subcategory_image') is-invalid @enderror" type="text" name="subcategory_image" placeholder="300 X 80">
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="subcategory_name" type="text"
                                       ...
                                       value="{{ old('subcategory_name') }}" autocomplete="title" autofocus>
