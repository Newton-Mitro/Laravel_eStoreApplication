                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('service.index')}}">Service Zone</a>
                            </li>
        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title text-bold">Edit Service Zones</h3>
                </div>
                <div class="card-body">
                    <div class="card-body">
                        <form method="POST" action="{{ route('service.update',$zone->id) }}">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="store_id" id="store_id">
                                        @foreach($stores as $store)
                                            @if($store->id == $zone->store_id)
                                                <option selected name="store_id"
                                                        value="{{$store->id}}">{{$store->store_name}}</option>
                                            @else
                                                <option name="store_id"
                                                        value="{{$store->id}}">{{$store->store_name}}</option>
                                            @endif
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="zone_name" type="text"
                                           ...
                                           name="zone_name"
                                           value="{{ $zone->zone_name }}" autocomplete="zone_name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="shipping_cost" type="number"
                                           ...
                                           value="{{ $zone->shipping_cost }}" autocomplete="shipping_cost" autofocus step="any">
