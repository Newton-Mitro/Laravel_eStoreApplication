    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mt-3 mb-2">
                <a href="{{route('slider.show',['id'=>$slide->id])}}" class="btn btn-sm btn-success">View Slide</a>
            </div>
        </div>
    </section>
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-bold">Edit Slider</h3>
            </div>
            <div class="card-body">
                <div class="card-body">
                    <form method="POST" action="{{ route('slider.update',['id'=>$slide->id]) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text"
                                       ...
                                       value="{{ $slide->title }}" autocomplete="title" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="subtitle" type="text"
                                       ...
                                       value="{{ $slide->subtitle }}" autocomplete="subtitle" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text"
                                       ...
                                       value="{{ $slide->description }}" autocomplete="description" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="button_title" type="text"
                                       ...
                                       value="{{ $slide->button_title }}" autocomplete="button_title" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="button_link" type="text"
                                       ...
                                       value="{{ $slide->button_link }}" autocomplete="button_link" autofocus>
